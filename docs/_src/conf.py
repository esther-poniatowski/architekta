"""
Sphinx configuration for Architekta API documentation.

Sphinx scope is restricted to the API tree under this directory. The prose
documentation (docs/index.md, docs/guide/, docs/internals/, docs/adr/,
docs/audits/) is hand-written Markdown and not part of the Sphinx build.
...
# the cross-references autodoc generates (e.g. `#module-architekta.env.operations`,
# `#architekta.env.operations.EditableInstallRequest`) actually resolve on GitHub.
